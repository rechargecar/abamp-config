...
public void createSliders()
{
  ...
  s1 = controlP5.addSlider("SOC", 0, 100, 50, SOCX+50, SOCY, SOCW-50, SOCH);  //this is the SOC slider
...
//  s2.setColorForeground(0xFF95001E);
  ...
  s4 = controlP5.addSlider("AMP", 0, 800, 0, SOCX+50, AMPY, SOCW-50, 20);   // this is the tach output slider
  ...
  s5 = controlP5.addSlider("PPR", 1, 4, 0, CAPX+50, TACHY-15, 100, 20);  // this is the PPR slider
  ...
  s6 = controlP5.addSlider("FULL", 0, 1023, (1024/4)*3, 125, SOC2, SOCW-50, 20);  //this is the FULL slider
...
//  s6.setColorActive(0xFF67E46F);
  ...
  s7 = controlP5.addSlider("EMPTY", 0, 1023, (1024/4)*1, 125, SOC3, SOCW-50, 20);  //this is the EMPTY slider
...
public void createlabels()
{
  ...
  LevelLabel = controlP5.addTextlabel("label2", "LEVEL TEST", 34, SOCY);  //SOCX-64
  ...
  FGLabel = controlP5.addTextlabel("label8", "FUEL GAUGE SETUP", 34, LLY-31+78+6);   //LLX-64
  FGLabel.draw(this); 
  FGLabel.setControlFont(labelFont1);
  FGLabel.setColorValue(255);

  TALabel = controlP5.addTextlabel("label9", "TACH-AMMETER", 34, LLY+186+75-57);   //LLX-64
  TALabel.draw(this); 
  TALabel.setControlFont(labelFont1);
  TALabel.setColorValue(255);
  
  PPRLabel = controlP5.addTextlabel("label28", "PULSES/REV", 34, TACHY-15 );   //CAPX-55
  PPRLabel.draw(this); 
  PPRLabel.setControlFont(labelFont);
  
  LLSLabel = controlP5.addTextlabel("label29", "LOW LEVEL SIGNAL", 34, LOWY1-22 );   //CAPX-55
  LLSLabel.draw(this); 
  LLSLabel.setControlFont(labelFont1);
  LLSLabel.setColorValue(255);
  
  TACHLabel = controlP5.addTextlabel("label30", "AMP TEST", 34, SOCY-27);  //SOCX-64
  TACHLabel.draw(this); 
  TACHLabel.setControlFont(labelFont);
  ...
  SOClevellabel = controlP5.addTextlabel("label4", SOCvalue+" %", SOCX+SOCW+5, SOCY);    

  PPRlabel = controlP5.addTextlabel("label15", tach +" ", TACHX+165+50, TACHY-15); 
  
  PPRlabel_LOADED = controlP5.addTextlabel("label24", tach +" ", LOADX, TACHY-15);  // NEW
...
public void createButtons()
{
  ...
  LOAD = controlP5.addButton("LOAD", 0, LOADX, LOADY, 60, 25);
  ...
  RUN = controlP5.addButton("RUN", 0, LOADX, AMPY, 60, 47);
  controlP5.getController("RUN")
    .getCaptionLabel()
      .setControlFont(labelFont);
  RUN.captionLabel().getStyle().marginTop = 1;
  RUN.captionLabel().getStyle().marginLeft = 7;
  RUN.setColorBackground(color(60));   // make it grey
  RUN.setColorForeground(color(60));
  RUN.setColorActive(color(60));
